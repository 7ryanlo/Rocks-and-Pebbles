...
const char WORDFILENAME[] = "/Users/Ryan/Documents/workspaceXCODE/CS 31 Projects/Project 5 Rocks/words.txt";

//Tester for easier words
//int loadWords(char words[][7], int maxWords)
//{
//    if (maxWords < 2)
//        return 0;
//    strcpy(words[0], "eerie");
//    strcpy(words[1], "meat");
//    strcpy(words[2], "grease");
//    strcpy(words[3], "eager");
//    strcpy(words[4], "agree");
//    strcpy(words[5], "condor");
//    strcpy(words[6], "rave");
//    strcpy(words[7], "goose");
//
//
//    return 8;
//}
